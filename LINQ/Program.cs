...
namespace LINQ
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                new("A1", new DateTime(random.Next(1950,1960), 1, 1), true),
                new("A2", new DateTime(random.Next(1950, 1960), 2, 2), false),
                new("A3", new DateTime(random.Next(1950, 1960), 3, 3), true),
                new("A4", new DateTime(random.Next(1950, 1960), 4, 4), false),
                new("A5", new DateTime(random.Next(1950, 1960), 5, 5), true),
                new("A6", new DateTime(random.Next(1950, 1960), 6, 6), false),
                new("A7", new DateTime(random.Next(1950, 1960), 7, 7), true),
                new("A8", new DateTime(random.Next(1950, 1960), 8, 8), false),
                new("A9", new DateTime(random.Next(1950, 1960), 9, 9), true),
                new("A10", new DateTime(random.Next(1950, 1960), 10, 10), false),
                new("A11", new DateTime(random.Next(1960, 1970), 11, 11), true),
                new("A12", new DateTime(random.Next(1960, 1970), 12, 12), false),
                new("A13", new DateTime(random.Next(1960, 1970), 1, 13), true),
                new("A14", new DateTime(random.Next(1960, 1970), 2, 14), false),
                new("A15", new DateTime(random.Next(1960, 1970), 3, 15), true),
                new("A16", new DateTime(random.Next(1960, 1970), 4, 16), false),
                new("A17", new DateTime(random.Next(1960, 1970), 5, 17), true),
                new("A18", new DateTime(random.Next(1960, 1970), 6, 18), false),
                new("A19", new DateTime(random.Next(1960, 1970), 7, 19), true),
                new("A20", new DateTime(random.Next(1960, 1970), 8, 20), false),
                new("A21", new DateTime(random.Next(1970, 1980), 9, 21), true),
                new("A22", new DateTime(random.Next(1970, 1980), 10, 22), false),
                new("A23", new DateTime(random.Next(1970, 1980), 11, 23), true),
                new("A24", new DateTime(random.Next(1970, 1980), 12, 24), false),
                new("A25", new DateTime(random.Next(1970, 1980), 1, 25), true),
                new("A26", new DateTime(random.Next(1970, 1980), 2, 26), false),
                new("A27", new DateTime(random.Next(1970, 1980), 3, 27), true),
                new("A28", new DateTime(random.Next(1970, 1980), 4, 28), false),
                new("A29", new DateTime(random.Next(1970, 1980), 5, 29), true),
                new("A30", new DateTime(random.Next(1970, 1980), 6, 1), false),
                new("A31", new DateTime(random.Next(1980, 1990), 7, 2), true),
                new("A32", new DateTime(random.Next(1980, 1990), 8, 3), false),
                new("A33", new DateTime(random.Next(1980, 1990), 9, 4), true),
                new("A34", new DateTime(random.Next(1980, 1990), 10, 5), false),
                new("A35", new DateTime(random.Next(1980, 1990), 11, 6), true),
                new("A36", new DateTime(random.Next(1980, 1990), 12, 7), false),
                new("A37", new DateTime(random.Next(1980, 1990), 1, 8), true),
                new("A38", new DateTime(random.Next(1980, 1990), 2, 9), false),
                new("A39", new DateTime(random.Next(1980, 1990), 3, 10), true),
                new("A40", new DateTime(random.Next(1980, 1990), 4, 11), false),
